  ...
  return (  
    <>
      ...
      <div className='Content'>
        <h3 className='Content__Title'> Our Commitment to #BeCrueltyFree</h3>
        ...
        <p className='Content__Content'>
          ...
          f classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, 
